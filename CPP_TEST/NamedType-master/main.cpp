...
{
public:
    _Rectangle(Width width, Height height) : width_(width.get()), height_(height.get()) {}
...
{
    _Rectangle r(Width(10_meter), Height(12_meter));
...
{  
    std::string change_value = "value2";
    name.set(change_value);
}
...
TEST_CASE("Named arguments")
{
    ...
    {
        std::cout << firstName.get() << std::endl;
